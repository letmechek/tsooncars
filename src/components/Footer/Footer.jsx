...
export default function FooterWithSitemap() {
  ...
  return (
    ...
    <footer className="flex bg-stone-500 flex-col items-center text-center text-white">
    ...
    <div className="flex justify-center ">
      <form action="">
        <div
          ...
          <input
                  type="text"
                  className="peer block min-h-[auto] w-full rounded border border-black bg-transparent px-3 py-[0.32rem] leading-[1.6] text-neutral-200 outline-none transition-all duration-200 ease-linear focus:placeholder:opacity-100 data-[te-input-state-active]:placeholder:opacity-100 motion-reduce:transition-none dark:text-neutral-200 dark:placeholder:text-neutral-200 [&:not([data-te-input-placeholder-active])]:placeholder:opacity-0"
          ...
          <div class="mb-6 md:mr-auto pt-2">
            <button
              type="submit"
  ...
  <div class="mb-6 pr-8 pl-8 font-custom-font ">
      <p>
  ...
  <div
   ...
   >
    © 2023 Copyright:
    <Link class="text-white" to="https://tw-elements.com/">TW elements</Link>
  </div>
</footer>
